...
import com.example.personalcolor.databinding.ActivityWarmsurveyBinding
...
class WarmSurveyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_warmsurvey)
        ...
        nextBtn.setOnClickListener {
            ...
            if (!allChecked || !radioButtonChecked) {
                ...
                // 봄, 가을 판단
                when{
                    radioButton11.isChecked -> spring += 1
                    radioButton12.isChecked -> fall += 1
                }
                when{
                    radioButton21.isChecked -> spring += 1
                    radioButton22.isChecked -> fall += 1
                }
                when{
                    radioButton31.isChecked -> spring += 1
                    radioButton32.isChecked -> fall += 1
                }
                when{
                    radioButton41.isChecked -> spring += 1
                    radioButton42.isChecked -> fall += 1
                }
                when {
                    radioButton51.isChecked -> spring += 1
                    radioButton52.isChecked -> fall += 1
                    radioButton53.isChecked -> spring += 1
                    radioButton54.isChecked -> fall += 1
                }
