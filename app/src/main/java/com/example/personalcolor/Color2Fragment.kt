...
class Color2Fragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        // 레이아웃 인플레이션
        val view = inflater.inflate(R.layout.fragment_color2, container, false)
        // GridView 찾기
        val gridView: GridView = view.findViewById(R.id.color2GridView)
        // 이미지 리소스 설정
