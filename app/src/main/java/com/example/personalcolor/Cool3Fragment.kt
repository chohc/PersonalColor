...
class Cool3Fragment : Fragment() {
    companion object {
        fun newInstance(): Cool3Fragment {
            return Cool3Fragment()
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        // 레이아웃 인플레이션
        val view = inflater.inflate(R.layout.fragment_cool3, container, false)

        val imageView1: ImageView = view.findViewById(R.id.cool3_imageView1)
        val imageView2: ImageView = view.findViewById(R.id.cool3_imageView2)
        ...
        // 옷 투명 배경 제거하고 배치
        val overlayImageView1: ImageView = view.findViewById(R.id.cool3_overlayImageView1)
        val overlayImageView2: ImageView = view.findViewById(R.id.cool3_overlayImageView2)

        setImageViewWithTransparentBackground(overlayImageView1, R.drawable.summer_green)
        setImageViewWithTransparentBackground(overlayImageView2, R.drawable.winter_green)
