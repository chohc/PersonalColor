...
class Warm3Fragment : Fragment() {
    companion object {
        fun newInstance(): Warm3Fragment {
            return Warm3Fragment()
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        // 레이아웃 인플레이션
        val view = inflater.inflate(R.layout.fragment_warm3, container, false)
        ...
        setImageViewWithTransparentBackground(overlayImageView1, R.drawable.spring_green)
        setImageViewWithTransparentBackground(overlayImageView2, R.drawable.fall_green)
